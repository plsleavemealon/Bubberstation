...
/datum/preference/numeric/erp/belly_size_limit
	category = PREFERENCE_CATEGORY_GAME_PREFERENCES
	savefile_key = "belly_size_limit"
	savefile_identifier = PREFERENCE_PLAYER
	minimum = 1
	maximum = 10

/datum/preference/numeric/erp/belly_size_limit/create_default_value()
	return 4
...
/datum/preference/numeric/erp/breast_size_limit
	category = PREFERENCE_CATEGORY_GAME_PREFERENCES
	savefile_key = "breast_size_limit"
	savefile_identifier = PREFERENCE_PLAYER
	minimum = 0
	maximum = 19

/datum/preference/numeric/erp/breast_size_limit/create_default_value()
	return 16
...
/datum/preference/numeric/erp/butt_size_limit
	category = PREFERENCE_CATEGORY_GAME_PREFERENCES
	savefile_key = "butt_size_limit"
	savefile_identifier = PREFERENCE_PLAYER
	minimum = 1
	maximum = 8

/datum/preference/numeric/erp/butt_size_limit/create_default_value()
	return 4
...
/datum/preference/numeric/erp/penis_size_limit
	category = PREFERENCE_CATEGORY_GAME_PREFERENCES
	savefile_key = "penis_size_limit"
	savefile_identifier = PREFERENCE_PLAYER
	minimum = 1
	maximum = 7
